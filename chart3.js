...
class CandleStickChartWithFibonacciInteractiveIndicator extends React.Component {
    ...
    constructor(props) {
        ...
        this.handleDrawingObjectSelection = this.handleDrawingObjectSelection.bind(this);
    ...
    handleDrawingObjectSelection(interactives, moreProps, e) {
        if (this.state.enableInteractiveObject) {
            this.handleSelectionAlert(interactives, moreProps, e);
        } else if (this.state.enableFib) {
            this.handleSelectionFib(interactives);
        } else {
            this.handleSelection(interactives);
        }
    }
...
//Alerta
            ...
            case 46: { // DEL
              ...
              // Para Trendline
                if (this.state.selectedElement) {
                    const trends_1 = this.state.trends_1.filter(
                    each => each !== this.state.selectedElement
                    );
                    this.setState({
                    trends_1,
    ...
    handleChartClick = () => {
        // Desative a seleção de todos os elementos
        this.setState({
            enableTrendLine: false,
            enableInteractiveObject: false,
            enableFib: false
    ...
    handleButtonClick = () => {
        const trends_1 = this.state.trends_1; // Substitua esta linha conforme necessário
        this.onDrawCompleteChart1(trends_1);
    }
    ...
    render() {
        ...
        <div className="dark">
             ...
             <button onClick={this.handleButtonClick}>Chamar onDrawCompleteChart1</button>

            <button onClick={() => this.setState({ enableFib: true, enableInteractiveObject: false, enableTrendLine: false })}>
                Ativar Fibonacci
            </button>
            <button onClick={() => this.setState({ enableFib: false, enableInteractiveObject: true, enableTrendLine: false })}>
                Ativar Alerta
            </button>
            <button onClick={() => this.setState({ enableFib: false, enableInteractiveObject: false, enableTrendLine: true })}>
                Ativar TrendLine
            </button>
          ...
          >
            ...
            <DrawingObjectSelector
                ...
                onSelect={this.handleDrawingObjectSelection}
